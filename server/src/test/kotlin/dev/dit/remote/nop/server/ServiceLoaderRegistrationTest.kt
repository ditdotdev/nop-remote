...
class ServiceLoaderRegistrationTest : StringSpec({
    "NopRemoteServer is discoverable as a dev.dit.remote.RemoteServer ServiceLoader provider" {
        ServiceLoader.load(RemoteServer::class.java).any { it is NopRemoteServer } shouldBe true
    }
})
